...
- Creator: Command line and application for creating Annotated Torrents
...
- Archive: Library management software for maintaining a personal library of content, personally or professionally hosted
